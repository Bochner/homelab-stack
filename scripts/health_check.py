...
class HealthChecker:
        ...
        try:
            ...
            if health:
                ...
                if status == 'healthy':
                    ...
                    return False, f"Container is unhealthy: {health.get('Log', [])[-1] if health.get('Log') else 'No log'}"
                else:
    ...
    def check_traefik_health(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return True, f"API accessible, {len(services)} services, {len(routers)} routers"
            else:
    ...
    def check_pihole_health(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            # Test DNS resolution
            result = container.exec_run("dig +short +norecurse +retry=0 @127.0.0.1 pi.hole")
    ...
    def check_uptime_kuma_health(self) -> Tuple[bool, str]:
        ...
        try:
            # Check container health
            container_healthy, container_msg = self.check_container_health("uptime-kuma")
            if not container_healthy:
                return False, f"Container check failed: {container_msg}"
    ...
    def check_homepage_health(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            result = container.exec_run("wget --no-verbose --tries=1 --spider http://localhost:3000")
    ...
    def check_network_connectivity(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            return True, f"Network active with {len(containers_in_network)} containers: {', '.join(containers_in_network)}"
    ...
    def check_volumes(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            return True, f"All required volumes present ({len(required_volumes)} volumes)"
